    ...
    <div class="col-md-6 col-xl-4">                       
      <div class="card">
        <div class="card-body">
          <div class=" align-items-center">
            ...
            <div class="media-body overflow-hidden">
              ...
              <input type="hidden" id="base" value="<?php echo base_url(); ?>">
                <input type="hidden" id="friend_id<?php echo $row->id;?>" value="<?php echo $row->id;?>" />
          ...
          <button id="<?php echo $row->id;?>" class="tile-link btn btn-success send" >Send Request</button>
 ...
 friend_id=$('#friend_id'+id).val();
  ...
  var base_url = $('#base').val();
    ...
    $.ajax({
       ...
       url: base_url+'index.php/UserController/saveRequset',
