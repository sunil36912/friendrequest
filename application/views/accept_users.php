         ...
         <img class="img-fluid img-thumbnail" src="<?php echo base_url('uploads/files/'.$row->profile_pic); ?>" />
            <div class="media-body overflow-hidden">
              ...
              <input type="hidden" id="base" value="<?php echo base_url(); ?>">
                <input type="hidden" id="friend_id<?php echo $row->id;?>" value="<?php echo $row->user_one;?>" />
          ...
          <button id="<?php echo $row->id;?>" class="tile-link btn btn-success send" >Accept Request</button>
          <button id="<?php echo $row->id;?>" class="tile-link btn btn-danger cancel">Reject Request</button>
        </div>
      </div>
    </div>
    <?php
 ...
 friend_id=$('#friend_id'+id).val();
  ...
  var base_url = $('#base').val();
    ...
    $.ajax({
       ...
       url: base_url+'index.php/UserController/updateRequset',

       type: 'POST',

       data: {id:id,user_id: user_id, friend_id: friend_id},
